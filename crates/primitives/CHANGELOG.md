...
## [2.0.0](https://github.com/ch4ns1q1/revm/compare/revm-primitives-v1.3.0...revm-primitives-v2.0.0) - 2024-01-19
...
- *(deps)* run `cargo update`, bump alloy-primitives ([#880](https://github.com/ch4ns1q1/revm/pull/880))
