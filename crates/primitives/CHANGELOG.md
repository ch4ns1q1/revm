...
## [5.1.0](https://github.com/ch4ns1q1/revm/compare/revm-primitives-v5.0.0...revm-primitives-v5.1.0) - 2024-06-28

### Added
- add helper function to mape EVMError's Database error variant ([#1567](https://github.com/ch4ns1q1/revm/pull/1567))
